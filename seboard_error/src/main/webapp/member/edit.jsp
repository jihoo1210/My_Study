...
<jsp:useBean id="mDao" class="seboard.dao.MemberDao" />
<c:set var="m" value="${mDao.findByUserid(sessionScope.loginUser) }" />

    <div class="mt-5">
       <h2 class="text-center fw-bold">회원가입</h2> 
       <div class="text-danger mb-3 text-center">*표는 필수 입니다.</div>
       <form id="joinForm" name="joinForm" action="<c:url value='/update' />" method="post">
          ...
          <li class="list-group-item py-3 d-flex align-items-center">
              ...
              <div class="col-2">
                 <input type="text" name="post" id="postcode" 
                        class="form-control" value="${m.post }">
              </div>
              <div class="col-2">
          ...
          <li class="list-group-item py-3 d-flex align-items-center">
              ...
              <div class="col-10">
                 <input type="text" name="addr" id="address" 
                        class="form-control mb-3" value="${m.addr1 }">
                 <input type="text" name="addr2" id="detailAddress" 
                        class="form-control" value="${m.addr2 }">
              </div>
          </li>
       </ul>
   ...
   <script>
     document.addEventListener('DOMContentLoaded', ()=> {
         ...
         joinForm.addEventListener("submit", (event) => {
        	 ...
        	 if(userpassInput && !userpassReg.test(userpassInput.value.trim())) {       		
        		 errors.push("비밀번호는 대문자,소문자,특수문자를 하나이상 포함하고, 총 4~10자여야 합니다.");
        	 }       	 
        	 */
        	 
        	 //3. 비밀번호 확인
        	 if(userpassInput && (userpassInput.value !== reuserpassInput.value)){

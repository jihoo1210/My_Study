...
<script>
  $(function(){
    ...
    <form class="writeform pt-5" action="<c:url value='/board/write' />" method="post">
    <div class="write mt-5">
        <div class="row">
            <div class="mb-5 col-md-6 row">
                <label for="username" class="col-sm-4 text-end">이름</label>
                <div class="col-sm-8">
                   <input type="text" id="username" class="form-control" name="writer" placeholder="이름">
                </div>
            </div>
            <div class="mb-5 col-md-6 row">
        ...
        <div class="btn-box text-center ms-140">
            <a href="list.jsp" class="btn btn-danger px-5 me-3">취소</a>
